...
if a.shape == b.shape:
        print("si tienen misma forma")
else:
        print("no tienen misma forma")
        

#8. ¿Es posible sumar a y b? ¿Por qué sí o por qué no?

# no es posible: deben tener las mismas dimensiones, arrays se suman posicion a posicion
...
d = a + c #funciona porque tienen las mismas dimensiones

#11. Imprime a y d. ¿Notas la diferencia y la relación entre los dos arrays en términos de los valores? Explica.
#print(f"matriz a {a}")
#print(f"matriz D {d}") 

#mismas dimensiones , cada posicion aumentada en razon de uno, 
...
print(f"la matriz D es : n\ {d}")
print(f"la matriz F es : n\ {f}")
